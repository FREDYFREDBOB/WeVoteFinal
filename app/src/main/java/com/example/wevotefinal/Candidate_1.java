...
public class Candidate_1 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_candidate_1);
    ...
    public void back (View view){
        Intent intentInfo = new Intent(Candidate_1.this, Show_Candidates.class);
